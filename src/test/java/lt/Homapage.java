...
//		String passWord="Liza@1702";
		...
		// Paths
		String downloadfolderPath = "C:\\Users\\Rishi\\Downloads";
		String folderToMovePath = "C:\\bid_automation\\ackdocs";
		...
		try {
			...
			String path = "C:\\bid_automation\\captchaImage.png";

			FileHandler.copy(src, new File(path));

			Thread.sleep(2000);

			String tessDataPath = "C:\\bid_automation\\TestData";
		...
		while ((driver.findElements(By.xpath("//input[@value=\"Acknowledge\"]"))) != null) {
			...
			String formNumber =driver.findElement(By.xpath("//span[@id=\"form_number_id\"]")).getText();;
			...
			String newFileName = formNumber+"-"+rfqFileName + ".xlsx";
